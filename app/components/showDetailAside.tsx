      ...
      {["Save", "Watched", "Like"].map((label, index) => {
        ...
        return (
          ...
          >
            ...
            <p className="text-black text-xs self-stretch text-center">{label}</p>
          </button>
        );
      })}
    </article>
    ...
    <article className="bg-white p-4 rounded-2xl text-black justify-center gap-2 flex items-center">
      ...
      <div aria-valuenow={rating} className="flex">
        {[...Array(5)].map((_, index) => {
          ...
          return (
            <div key={index} className="relative inline-block w-12 h-12 sm:w-[1.5rem] sm:h-[1.5rem]">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="w-full h-full text-blue-500 absolute inset-0" viewBox="0 0 24 24" fill="currentColor" style={{ clipPath: `inset(0 ${100 - fillPercent}% 0 0)` }}>
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                <path d="M8.243 7.34l-6.38 .925l-.113 .023a1 1 0 0 0 -.44 1.684l4.622 4.499l-1.09 6.355l-.013 .11a1 1 0 0 0 1.464 .944l5.706 -3l5.693 3l.1 .046a1 1 0 0 0 1.352 -1.1l-1.091 -6.355l4.624 -4.5l.078 -.085a1 1 0 0 0 -.633 -1.62l-6.38 -.926l-2.852 -5.78a1 1 0 0 0 -1.794 0l-2.853 5.78z" />
              </svg>
