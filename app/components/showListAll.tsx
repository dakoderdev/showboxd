...
type ShowListProps = {
  popularShows: { watch_count: number; shows: { show_id: number; name: string; img_vertical: string; }; }[] | null;
};

export default function ShowListAll({ popularShows }: ShowListProps) {
  return (
